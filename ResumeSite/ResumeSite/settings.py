...
SECRET_KEY = 'django-insecure-gh7bwu66*qpn2ww=*gmx5wety^3&s@-r!+2+_pv5dml%wr)5pa'
...
SECRET_KEY = os.environ.get("SECRET_KEY", "MhJi4V16egBN2bv7oqeI2WDcKpPuId8cFF27PLul9Ksf5AD!FBSjAfjcdGWnq6dV")
